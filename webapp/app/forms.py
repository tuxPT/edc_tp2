...
class RelatarForm(forms.Form):
    data_ocorrencia = forms.DateField(label='Data da ocorrência', input_formats=['%d-%m-%Y'],
    ...
    distrito = forms.CharField(label='Distrito',
                               widget=forms.Select(choices=DISTRITOS, attrs={'class': 'form-control'}))
    ...
    meiosTerrestres = forms.IntegerField(label='Meios Terrestres', min_value=0, initial=0,
                                         widget=forms.NumberInput(attrs={'class': 'form-control'}))
    opTerrestres = forms.IntegerField(label='Operacionais Terrestres', min_value=0, initial=0,
                                      widget=forms.NumberInput(attrs={'class': 'form-control'}))
    meiosAereos = forms.IntegerField(label='Meios Aéreos', min_value=0, initial=0,
                                     widget=forms.NumberInput(attrs={'class': 'form-control'}))
    opAereos = forms.IntegerField(label='Operacionais Aéreos', min_value=0, initial=0,
                                  widget=forms.NumberInput(attrs={'class': 'form-control'}))
